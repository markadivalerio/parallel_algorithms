...
{
    public sealed class clsHungarianAlgorithm
    {
       // private Action<string> updaterDelegate;
        ...
        public clsHungarianAlgorithm(int[,] costMatrix)//, Action<string> theDelegate)
        {
            //this.updaterDelegate = theDelegate;
        ...
        public int[] Run()
        {
            //this.updaterDelegate("Updating from Inside Class");
            ...
            #endregion
            //this.updaterDelegate("Completed from Inside Class");
            return _matchX;
        }
